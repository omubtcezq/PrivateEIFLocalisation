...
,draw=white] at (current bounding box) {
\immediate\write\metadatafile{\p1,\p2}
};
\immediate\closeout\metadatafile
\end{tikzpicture}
...
mooth, tension=.7] coordinates {(1.75,-9.5) (3.75,-7.75)};
	\draw [-latex] plot[smooth, tension=.7] coordinates {(6.25,-9.5) (4.25,-7.75)};
	
	\fill [lightgray]  (0.25,-8.25) rectangle (3.75,-9.25);
	\node at (2,-8.75) {$\mathcal{E}_{pk_0}(i'_{k,1})$, $\mathcal{E}_{pk_0}(I'_{k,1})$};
	
	\fill [lightgray]  (4.25,-8.25) rectangle (7.75,-9.25);
	\node at (6,-8.75) {$\mathcal{E}_{pk_0}(i'_{k,n})$, $\mathcal{E}_{pk_0}(I'_{k,n})$};
