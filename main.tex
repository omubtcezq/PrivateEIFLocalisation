...
% LINEAR-COMBINATION AGGREGATOR OBLIVIOUS ENCRYPTION
...
We formalize the security notion of Linear-Combination Aggregator Obliviousness (LCAO) as the following game between attacker and challenger: %see appendix
