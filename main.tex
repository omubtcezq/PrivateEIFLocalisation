...
\end{LaTeXdescription}
In the context of privacy-preserving localisation and state estimation, some of the aforementioned schemes have found applications. These have been summarised in the next section.
