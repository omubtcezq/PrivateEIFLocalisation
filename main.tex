...
\end{equation}
for each sensor $1 \leq i \leq n$. Computing the filter's prediction step can be either computed in the information filter form, or by first converting the information vector and matrix back to the state estimate and covariance, and using the normal EKF prediction equations.
