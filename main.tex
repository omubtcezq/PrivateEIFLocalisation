...
\end{equation}
with system noise that is zero mean and has covariance $\mathsf{Cov}[\vec{w}_k]=\mat{Q}_k$. Measurements of the system follow a measurement model dependent on sensor $i$, $0\leq i \leq n$, given by 
\begin{equation}
