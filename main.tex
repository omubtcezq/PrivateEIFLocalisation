...
\begin{LaTeXdescription}
    ...
    \item[$\mathsf{AggDec}(t, sk_0, l^{(t)}_1,\shrtdots,l^{(t)}_n)$] At instance $t$, the aggregator computes the aggregation of values $\sum^{n}_{i=1} a^{(t)}_i$ using its private key $sk_0$.
\end{LaTeXdescription}
