...
As $h'_i$ and $\mat{H}'_{k,i}$ can be written as linear combinations of powers of location elements in $\vec{x}_{k|k-1}$, $\vec{i}_{k,i}$ and $\mat{I}_{k,i}$ can too. 



After modifying measurements by . to produce modified measurement functions and Jacobians . and ., 

With the existence of \eqref{eqn:modified_measurement_model}, measurement vector and measurement matrix linear combinations can be given in a similar form by
\begin{equation}
    \begin{split}
